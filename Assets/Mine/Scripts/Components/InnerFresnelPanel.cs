...
public class InnerFresnelPanel : MonoBehaviour
{
    ...
    {
        float lerp = 0f;
        List<KeyframeData<float>> tempData2 = PartFile.GetInstance().KeyFrames.Fresnel2Keyframes;
        float fres1 = 0f;
        float fres2 = 0f;
    ...
    public void PreviewSlider()
    {
        ...
        previousFresnel = refToShape.CurrentShape.GetComponent<MeshRenderer>().material.GetFloat("_InnerFresnelThreshold");
        refToShape.CurrentShape.GetComponent<MeshRenderer>().material.SetFloat("_InnerFresnelThreshold", sliderValue);
    ...
    public void AddKeyframe()
    {
        ...
        PartFile.GetInstance().KeyFrames.AddKeyFresnel2(KeyframeMainWindow.SelectedFrame, fres);
    }
